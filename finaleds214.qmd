...
## Clean the dates from 1988 to 1995
...
## Plot it!
```{r}
# fix the years from 1985 to 1988
# change x-axis label to "Years"
# Need sites lines
...
ggplot(
  ...
  ggtitle("Concentrations in Bisley, Puerto Rico streams before and after Hurricane Hugo, 9-wk moving
  averages") +
  geom_line() +
  geom_point() +
